...
def _engine(pytestconfig, request, _transaction, mocker):
    ...
    # TODO: switch back to official plugin once the issue is fixe:
    # https://github.com/jeancochrane/pytest-flask-sqlalchemy/issues/14
    # for now, we use local version with this custom modfication
    # (engine.contextual_connect -> engine._contextual_connect)
